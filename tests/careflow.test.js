...
test('LegalFlow miniapp renders appointment and reminder cards', async()=>{const source=await readFile(new URL('../src/main.js',import.meta.url),'utf8'); assert.match(source,/案件挂号/); assert.match(source,/我的案件/); assert.match(source,/林律师/)})
